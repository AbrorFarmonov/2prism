            ...
            <div className="custom-container flex justify-between flex-col ">
                <div className='flex justify-between items-center h-[10vh]'>
                    ...
                    <nav className='hidden lg:flex items-center gap-[40px]'>
                        ...
                        <a className='text-inherit text-[14px] opacity-[0.7]' href="#">Hotels</a>
                        <a className='text-inherit text-[14px] opacity-[0.7]' href="#">Restaurants</a>
                        <a className='text-inherit text-[14px] opacity-[0.7]' href="#">Tours</a>
                        <a className='text-inherit text-[14px] opacity-[0.7]' href="#">Destinations</a>
                        <a className='text-inherit text-[14px] opacity-[0.7]' href="#">Activities</a>
                        <a className='text-inherit text-[14px] opacity-[0.7]' href="#">Contact</a>
                    </nav>
